...
- `COSMOS_VAE_CPU_OFFLOAD=1`: Keep the vision VAE on CPU between encode/decode calls to save about 1.3 GiB of GPU memory, at the cost of host/device transfer latency per call.
